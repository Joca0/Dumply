  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <h2 className="text-xl md:text-2xl font-bold mt-8 md:mt-0">Consulta de Equipamentos</h2>
        <Link to="/equipments/new" className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors text-center">
          Novo Equipamento
        </Link>
      </div>
        ...
        <table className="w-full text-left min-w-[600px] md:min-w-full">
          <thead className="bg-gray-700/50 text-gray-400 text-sm">
            <tr>
              ...
              <th className="p-4 hidden sm:table-cell">Número de Série</th>
